...
!-->
    ...
    <!-- A Adapter en fonction de vos données JSON -->
    var donnesSources = [
    ...
    //Cumul des tarifs
    var categories =[]; //Variable qui contiendra les donées pour highcharts
...
<!-- 
	Partie pour simplifier l'appel à highcharts 
	A modifier à vos risques et perils	
-->
